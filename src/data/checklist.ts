...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'hea-letter', label: 'Doctor’s letter for medication', note: 'Singapore restricts some drugs — check HSA rules.' },
  ...
  },
  {
    ...
    items: [
      { id: 'wea-umbrella', label: 'Compact umbrella', note: 'September sits between monsoons — short, heavy showers.' },
